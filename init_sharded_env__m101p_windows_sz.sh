...
# killall mongod
# killall mongos
# taskkill /IM mongod.exe  TODO: does not work
# taskkill /IM mongos.exe  TODO: does not work
...
start mongod --logpath "cfg-a.log" --dbpath \data\config\config-a --port 57040 --configsvr --smallfiles
start mongod --logpath "cfg-b.log" --dbpath \data\config\config-b --port 57041 --configsvr --smallfiles
start mongod --logpath "cfg-c.log" --dbpath \data\config\config-c --port 57042 --configsvr --smallfiles


# now start the mongos on a standard port
start mongos --logpath "mongos-1.log" --configdb localhost:57040,localhost:57041,localhost:57042
echo "Waiting 60 seconds for the replica sets to fully come online"
sleep 60
# TODO: have not figured out how to do sharing in scripts, only work manually on Windows for me
